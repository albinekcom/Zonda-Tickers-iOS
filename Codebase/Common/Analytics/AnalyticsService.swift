...
final class AnalyticsService {
    ...
    private init(firebaseAppType: FirebaseApp.Type = FirebaseApp.self,
    ...
    func trackView(tickerId: String? = nil) {
        ...
        analyticsType.logEvent(AnalyticsEventScreenView,
    ...
    private func trackAction(_ name: Track.Name,
