...
struct TickerRow: View {
    ...
    var body: some View {
        HStack {
            Text("\(ticker.first.currency)/\(ticker.second.currency)")
            Spacer()
...
struct TickerRow_Previews: PreviewProvider {
    ...
    static var previews: some View {
        ...
        let ticker = Ticker(id: "btc-pln", first: firstCurrency, second: secondCurrency, highestBid: 123, lowestAsk: 456, rate: 789, previousRate: 123)
